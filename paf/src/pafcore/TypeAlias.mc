...
namespace idlcpp
{
	...
	__pafcore__TypeAlias_Type::__pafcore__TypeAlias_Type() : ::pafcore::ClassType("TypeAlias", ::pafcore::type_alias)
	{
		...
		{
			::pafcore::InstanceProperty("type", 0, GetSingleton(), RuntimeTypeOf<::pafcore::Type>::RuntimeType::GetSingleton(), true, TypeAlias_get_type, 0, 0, 0),
		};
	...
	bool __pafcore__TypeAlias_Type::assign(void* dst, const void* src)
	{
		return false;
	}

	::pafcore::ErrorCode __pafcore__TypeAlias_Type::TypeAlias_get_type(::pafcore::InstanceProperty* instanceProperty, ::pafcore::Variant* that, ::pafcore::Variant* value)
	{
