...
namespace idlcpp
{
	...
	__pafcore__StaticMethod_Type::__pafcore__StaticMethod_Type() : ::pafcore::ClassType("StaticMethod", ::pafcore::static_method)
	{
		...
		{
			{RuntimeTypeOf<::pafcore::Metadata>::RuntimeType::GetSingleton(), base_offset_of(::pafcore::StaticMethod, ::pafcore::Metadata)},
		};
	...
	{
		delete_array(reinterpret_cast<::pafcore::RefCountObject<::pafcore::StaticMethod>*>(address));
	}
