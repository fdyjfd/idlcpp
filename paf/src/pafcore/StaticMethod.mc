...
namespace idlcpp
{
	...
	__pafcore__StaticMethod_Type::__pafcore__StaticMethod_Type() : ::pafcore::ClassType("StaticMethod", ::pafcore::static_method, "D:/DeepEye2018/deepeye/src/paf/pafcore/StaticMethod.i")
	{
		...
		{
			::pafcore::InstanceProperty("overloadCount", 0, GetSingleton(), RuntimeTypeOf<::size_t>::RuntimeType::GetSingleton(), false, StaticMethod_get_overloadCount, 0, 0, 0),
		};
	...
	bool __pafcore__StaticMethod_Type::assign(void* dst, const void* src)
	{
		return false;
	}

	::pafcore::ErrorCode __pafcore__StaticMethod_Type::StaticMethod_get_overloadCount(::pafcore::InstanceProperty* instanceProperty, ::pafcore::Variant* that, ::pafcore::Variant* value)
	{
