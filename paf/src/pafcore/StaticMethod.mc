...
namespace idlcpp
{
	...
	__pafcore__StaticMethod_Type::__pafcore__StaticMethod_Type() : ::pafcore::ClassType("StaticMethod", ::pafcore::static_method)
	{
		...
		{
			::pafcore::InstanceProperty("overloadCount", GetSingleton(), StaticMethod_get_overloadCount, RuntimeTypeOf<::size_t>::RuntimeType::GetSingleton(), ::pafcore::Metadata::by_value, false, 0, 0, ::pafcore::Metadata::by_value, false),
		};
		...
		{
			::pafcore::InstanceMethod("getArgument", StaticMethod_getArgument, s_getArgument_Overloads, 1),
			::pafcore::InstanceMethod("getArgumentCount", StaticMethod_getArgumentCount, s_getArgumentCount_Overloads, 1),
			::pafcore::InstanceMethod("getResult", StaticMethod_getResult, s_getResult_Overloads, 1),
		};
		m_methods = s_methods;
	...
	{
		paf_delete_array(reinterpret_cast<::pafcore::RefCountObject<::pafcore::StaticMethod>*>(address));
	}
